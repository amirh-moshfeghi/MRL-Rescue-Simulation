...
import mrl_2021.MRLConstants;
import mrl_2021.SampleModuleKey;
import mrl_2021.complex.firebrigade.BorderEntities;
import mrl_2021.complex.firebrigade.BuildingProperty;
import mrl_2021.complex.firebrigade.MrlFireBrigadeWorld;
import mrl_2021.util.Util;
import mrl_2021.world.entity.*;
import mrl_2021.world.helper.*;
import mrl_2021.world.routing.graph.GraphModule;
...
//            System.err.println(" getting MrlWorldHelper .......");
            if (worldInfo.getEntity(agentInfo.getID()) instanceof FireBrigade) {
                worldHelper = moduleManager.getModule(SampleModuleKey.AGENT_WORLD, "mrl_2021.complex.firebrigade.MrlFireBrigadeWorld");
            } else {
                worldHelper = moduleManager.getModule(SampleModuleKey.AGENT_WORLD, "mrl_2021.world.MrlWorldHelper");
            }
        } catch (Exception ex) {
            ex.printStackTrace();
            worldHelper = null;
